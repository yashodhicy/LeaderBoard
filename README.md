...
**LeaderBoard **  is to show marks from a game entering name and score. 
...
This project is [MIT](https://github.com/yashodhicy/LeaderBoard/blob/main/LICENSE) licensed.
